...
int hseek(int fd, unsigned long n){
	lseek(fd,0,SEEK_SET);
	while(n > 2000000){
		lseek(fd,2000000*BLOCKSIZE,SEEK_CUR);
		n -= 2000000;
	}
...
int main(int argc, char *argv[]){
	...
	while(currsector<156250001){
		...
		coarsetrack = coarse_boundary(fd,align,startzone,400,drt);
		expectboundary = coarsetrack;
		range = 32;
