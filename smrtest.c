...
int main(int argc, char *argv[]){
	...
	double skew=0;
	double verify=0;
//	unsigned long startsector=18878941;
//	unsigned long startsector=16183541;
//	unsigned long startsector=16183361;
//	unsigned long startsector=24101341;
//	unsigned long startsector=24091741;
//	unsigned long startsector=40518361;
	unsigned long startsector=46799127;
//	unsigned long startsector=46787674;
	int count=0;
	unsigned long currsector=startsector;
	while(currsector<46799128){
		...
		if(abs(verify-skew)<1.0){
			...
			printf("verify1 != verify2, current Sector: %lu, skew: %f\n", currsector,skew);
		}
		currsector+=4800;
	}
	return 0;
